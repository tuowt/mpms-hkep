...
namespace Hkep\Kernel\Traits;

use Hkep\Kernel\Contracts\Arrayable;
use Hkep\Kernel\Exceptions\InvalidArgumentException;
use Hkep\Kernel\Exceptions\InvalidConfigException;
use Hkep\Kernel\Http\Response;
use Hkep\Kernel\Support\Collection;
...
trait ResponseCastable
{
     ...
     *
     * @return array|\Hkep\Kernel\Support\Collection|object|\Psr\Http\Message\ResponseInterface|string
     *
