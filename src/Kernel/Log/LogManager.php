...
class LogManager implements LoggerInterface {
    /**
     * @var \Hkep\Kernel\ServiceContainer
     */
    protected $app;
     ...
     *
     * @param \Hkep\Kernel\ServiceContainer $app
     */
    ...
    protected function createEmergencyLogger() {
        return new Monolog('Hkep', $this->prepareHandlers([
            new StreamHandler(
                \sys_get_temp_dir() . '/Hkep/Hkep.log', $this->level(['level' => 'debug'])
            )
        ]));
    }
